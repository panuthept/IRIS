...
# echo "Running WildGuard-IRISL2 on layer 19 (Benign only + Long run)"
# CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --num_processes=4 scripts/iris_l2_wildguard.py \
# --iris_config ./data/iris_l2_configs/benign_only_configs/layer_19.json \
# --model_name allenai/wildguard \
# --train_eval_split 0.9 \
...
# --output_dir ./finetuned_models/iris_l2_wildguard_layer_19_benign_only_10_epochs_v2 \
# --use_lora \
# --lora_rank 128

echo "Running WildGuard-IRISL2 on layer 19 (Long run)"
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --num_processes=4 scripts/iris_l2_wildguard.py \
--iris_config ./data/iris_l2_configs/layer_19_b0h1.json \
--model_name allenai/wildguard \
--train_eval_split 0.9 \
--max_seq_length 2048 \
--batch_size 1 \
...
--eval_steps 60 \
--save_total_limit 1000 \
--output_dir ./finetuned_models/iris_l2_wildguard_layer_19_b0h1_v2 \
--use_lora \
--lora_rank 128