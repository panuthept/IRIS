...
def get_eval_results(result_path: str) -> Dict[str, List[float]]:
    ...
    with open(result_path, "r") as f:
        for line in f:
            ...
            for refusal_result in example["refusal_results"]:
                results[get_gold_label(example["prompt_gold_label"])].append(int(refusal_result[0]))
    return results
...
if __name__ == "__main__":
    ...
    paths = {
        "general": [
            os.path.join(base_path, "general", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "ta", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "th", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "tl", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "ms", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "in", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "my", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "general", "vi", "test", "eval_refusal.jsonl"),
        ],
        "cultural_en": [
            os.path.join(base_path, "en_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ta_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "th_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "tl_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ms_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "in_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "my_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "vi_cultural", "en", "test", "eval_refusal.jsonl"),
        ],
        "cultural_local": [
            os.path.join(base_path, "en_cultural", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ta_cultural", "ta", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "th_cultural", "th", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "tl_cultural", "tl", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ms_cultural", "ms", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "in_cultural", "in", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "my_cultural", "my", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "vi_cultural", "vi", "test", "eval_refusal.jsonl"),
        ],
        "cultural_handwritten_en": [
            os.path.join(base_path, "ta_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "th_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "tl_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ms_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "in_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "my_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "vi_cultural_handwritten", "en", "test", "eval_refusal.jsonl"),
        ],
        "cultural_handwritten_local": [
            os.path.join(base_path, "ta_cultural_handwritten", "ta", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "th_cultural_handwritten", "th", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "tl_cultural_handwritten", "tl", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "ms_cultural_handwritten", "ms", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "in_cultural_handwritten", "in", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "my_cultural_handwritten", "my", "test", "eval_refusal.jsonl"),
            os.path.join(base_path, "vi_cultural_handwritten", "vi", "test", "eval_refusal.jsonl"),
        ]
    }
